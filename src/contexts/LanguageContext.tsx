...
const translations: Language[] = [
	{
		...
		AboutBold: 'Med andra ord, så har jag stor erfarenhet av samspelet mellan människa och maskin - en kombination som är både unik och värdefull.',
	...
	},
	{
		...
		AboutBold: 'In other words, I have extensive insights into the intersection between human and machine - a combination that is both unique and valuable.',
