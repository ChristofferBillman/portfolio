...
exports.useLanguageContextSetter = exports.useLanguageContext = void 0;
const jsx_runtime_1 = require("react/jsx-runtime");
const react_1 = require("react");
const LangContext = (0, react_1.createContext)({});
const LangSetterContext = (0, react_1.createContext)({});
const useLanguageContext = () => {
    const context = (0, react_1.useContext)(LangContext);
...
const useLanguageContextSetter = () => {
    const context = (0, react_1.useContext)(LangSetterContext);
    if (context === undefined) {
        throw new Error('LanguageContextSetter must be used within a LanguageContextProvider');
    }
    return context;
};
exports.useLanguageContextSetter = useLanguageContextSetter;
function LanguageContextProvider({ children }) {
    const [lang, setLang] = (0, react_1.useState)(translations.find(lang => lang.Name === getLocale()));
    const langSetter = (language) => {
        setLang(translations.find(lang => lang.Name === language));
    };
    if (lang === undefined) {
        throw new Error(`Language ${getLocale()} not found`);
    }
    return ((0, jsx_runtime_1.jsx)(LangSetterContext.Provider, { value: langSetter, children: (0, jsx_runtime_1.jsx)(LangContext.Provider, { value: lang, children: children }) }));
}
exports.default = LanguageContextProvider;
function getLocale() {
...
const translations = [
    {
        ...
        AboutBold: 'Med andra ord, så har jag insikt och förståelse för samspelet mellan människa och maskin - en kombination som är både unik och värdefull.',
